...
const Header = () => {
  ...
  return (
    <div className="fixed  bg-cyan-700 w-screen flex justify-between md:px-16 px-5">
      ...
      <div className="mt-5 bg-amber-600 hover:bg-amber-700 text-white  px-2 rounded-full h-7">
