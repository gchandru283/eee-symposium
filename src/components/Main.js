  ...
  return (
    <div className="">
      <section className="flex h-screen w-100 bg-gradient-to-b from-black to-slate-950 justify-center items-center ">
        <img
          src="assets/icons/ekna-logo.png"
          alt=""
      ...
      <section className="h-fit w-100 py-10 bg-gradient-to-b from-slate-950 to-slate-800">
        <div className="  w-10/12 m-auto items-center justify-center">
          ...
          <p className="lg:text-justify text-white lg:text-2xl text-lg lg:pt-10 pt-5">
            ...
            students at AURCC's Electrical and Electronics Engineering
            ...
            undoubtedly give an opportunity for aspiring engineers to develop
            their abilities and improve their performance. We take immense
            pleasure to welcome you all to Ekna'23 which will indubitably be
            "The Rise" for each and every individual who turns up for this
            Energy packed and Exciting event. We guarantee you the best day that
            you can have inside our campus and we hope, you can carry those
            memories along with you. Gear yourself up for an ethereal experience
            on November 7,2023.
          </p>
        </div>
        ...
        <div className="flex flex-wrap w-full pb-5 justify-center items-center">
          <div className="w-full lg:w-2/5">
            <img
              ...
              alt=""
              className="w-56 mx-auto lg:w-96"
            />
          </div>
          <div className="w-4/5 mx-auto lg:w-1/2 pb-5">
            <ul className="mx-auto text-white lg:text-xl text-md font-semibold">
              <li className="mx-auto my-1">
                It's an one day Inter-college Techno-Cultural fest.
              </li>
              <li className="mx-auto my-1">
                Overall championship will be awarded.
              </li>
              <li className="mx-auto my-1">
                It's an Inter-department and inter-college fest so that any
                college student can participate.
              </li>
              <li className="mx-auto my-1">
                Exciting cash prizes and rewards are waiting for the winners.
              </li>
              <li className="mx-auto my-1">
                Participation certificates will be provided for all the
                participants.
              </li>
              <li className="mx-auto my-1">
          ...
          <div className="lg:text-xl text-md font-semibold text-yellow-400 text-center w-full flex justify-center flex-wrap lg:gap-x-4 gap-x-2 px-10 pt-10">
                <p>**Registration Extended till  : Nov 5th - 6:00 PM</p> <p>
          </div>
